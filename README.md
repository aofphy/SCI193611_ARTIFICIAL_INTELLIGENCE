...
| 2 | Intelligent Agents | **Tutorial:** Agent design | [`python-tutorial/tutorial_code/exercises/`](./python-tutorial/tutorial_code/exercises) · [`slide/lecture2.pdf`](./slide/lecture2.pdf) · [`aima/slide_workshop/intelligent_agents_slides2.pdf`](./aima/slide_workshop/intelligent_agents_slides2.pdf) + [`aima/agents.ipynb`](./aima/agents.ipynb) *(workshop + runnable, BlindDog/Wumpus demo)* |
...
| 4 | Adversarial Search – Minimax, MCTS | **Exercise 1 (HexaPawn)** + Minimax agent | [`slide/hexapawact.pdf`](./slide/hexapawact.pdf), [`hexapaw.html`](./hexapaw.html), [`gameHexaPawn.html`](./gameHexaPawn.html), [`projects/project1/`](./projects/project1) (Minimax) · [`slide/lecture4_th.pdf`](./slide/lecture4_th.pdf) · [`aima/slide_workshop/Game-Playing.pdf`](./aima/slide_workshop/Game-Playing.pdf) + [`aima/games.ipynb`](./aima/games.ipynb) *(workshop + runnable, Minimax/Alpha-Beta)* |
| 5 | Logic & Automated Planning | **Project 1:** Search & Planning | [`labs/w05_logic_planning.ipynb`](./labs/w05_logic_planning.ipynb) *(runnable)* · [`aima/slide_workshop/10-Knowledge-Base.pdf`](./aima/slide_workshop/10-Knowledge-Base.pdf) + [`aima/logic.ipynb`](./aima/logic.ipynb), [`aima/slide_workshop/CSP_proposition.pdf`](./aima/slide_workshop/CSP_proposition.pdf) (CSP + Propositional Logic) + [`aima/csp.ipynb`](./aima/csp.ipynb), [`aima/slide_workshop/12-Basic-Planning.pdf`](./aima/slide_workshop/12-Basic-Planning.pdf) + [`aima/planning.ipynb`](./aima/planning.ipynb) *(workshop + runnable)* |
