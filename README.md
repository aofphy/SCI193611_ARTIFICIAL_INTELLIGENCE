...
| 4 | Adversarial Search – Minimax, MCTS | **Exercise 1 (HexaPawn)** + Minimax agent | [`slide/hexapawact.pdf`](./slide/hexapawact.pdf), [`hexapaw.html`](./hexapaw.html), [`gameHexaPawn.html`](./gameHexaPawn.html), [`projects/project1/`](./projects/project1) (Minimax) · [`slide/lecture4_th.pdf`](./slide/lecture4_th.pdf) | [`slide_workshop/Game-Playing.pdf`](./aima/slide_workshop/Game-Playing.pdf) + [`games.ipynb`](./aima/games.ipynb) *(Minimax/Alpha-Beta)* | [<img src="./figures/lec3/adversarial-search-cartoon.png" width="100" alt="Week 4 preview">](./slide/lecture4_th.pdf) |
...
| 6 | Probabilistic Reasoning – Bayes Nets | **Exercise 2** | [`code/lecture5-cherries.ipynb`](./code/lecture5-cherries.ipynb) · [`slide/lecture5_th.pdf`](./slide/lecture5_th.pdf) | — | [<img src="./figures/lec5/bn-cartoon.png" width="100" alt="Week 6 preview">](./slide/lecture5_th.pdf) |
